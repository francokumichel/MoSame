...
class Llamada0800(db.Model):
    ...
    situaciones_vulnerabilidad = db.relationship('SituacionVulnerabilidad', secondary=llamada0800_sit_vuln, backref="personas_cetecsm")
    ...
    nom_y_ape = db.Column(db.String(100))
    dni = db.Column(db.String(10))
    telefonos = db.relationship("Telefono", backref="llamada0800_id")
    emails = db.relationship("Email", backref="llamada0800_id")
