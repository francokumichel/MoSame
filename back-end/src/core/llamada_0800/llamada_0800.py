...
class Llamada0800(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    motivo_nombre = db.Column(db.String(100), db.ForeignKey("motivo_consulta.nombre"), nullable=False)
    como_ubico_forma = db.Column(db.String(100), db.ForeignKey("como_ubico.forma"))
    ...
    identidad_genero_tipo = db.Column(db.String(100), db.ForeignKey('identidad_genero.tipo'))
    ...
    detalle_motivo_motivo = db.Column(db.String(100), db.ForeignKey("detalle_motivo_consulta.motivo"), nullable=False)
    # malestares_emocionales = db.Column(db.String(100), db.ForeignKey("malestar_emocional.tipo")) # TODO: Cambiar para que sea mucho a muchos (tabla intermedia)
    ...
    motivo_derivacion_tipo = db.Column(db.String(100), db.ForeignKey('motivo_general_derivacion.tipo'))
