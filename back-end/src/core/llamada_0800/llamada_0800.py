...
class Llamada0800(db.Model):
    ...
    malestares_emocionales = db.Column(db.String(256))
    malestares_emocionales_otro = db.Column(db.String(100))
    situaciones_vulnerabilidad = db.Column(db.String(256))
    ...
    telefonos = db.Column(db.String(256))
    emails = db.Column(db.String(256))
