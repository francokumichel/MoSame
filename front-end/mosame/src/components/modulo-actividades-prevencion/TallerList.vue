<template>
    <div class="table-responsive">
        <table v-if="talleres" class="table table-sm table-responsive text-center text-nowrap table-hover">
            ...
            <tbody>
                <tr v-for="taller in talleres" :key="taller">
                    ...
                    <td>{{ taller.usuario_carga.name }} {{ taller.usuario_carga.last_name }}</td>
